...
--
-- Servidor: db
-- Tiempo de generación: 23-10-2024 a las 21:20:14
...
--
CREATE DATABASE IF NOT EXISTS `Pt04_Santi_Onieva` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
CREATE TABLE `articles` (
  ...
  `autor` int NOT NULL,
  `ruta_imatge` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
...
(12, 'admin', 'admin@oni.es', '$2y$10$bDYZJIaFBwQrUqQs114VJuFlOtr4Roq8..MYfknWMMEo8XzSDCO5u', 'Santi'),
